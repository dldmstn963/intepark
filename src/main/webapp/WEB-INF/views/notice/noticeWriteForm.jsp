...
<table align="center" >
<tr><th>제목</th><td><input type="text" name="noticetitle" size="50" placeholder="제목을 작성해주세요."></td></tr>
...
<tr><th>내용</th><td><textarea name="noticecontent" rows="5" cols="50" placeholder="내용을 입력해 주세요"></textarea></td></tr>
<tr><th colspan="2">
