...
<!-- ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -->		
	...
	<!-- ------------------------------------------------------------포트폴리오 탭 구역 시작---------------------------------------------------------------------- -->	              
		              ...
		              <form action="insertPF5.do" method="post" enctype="multipart/form-data">
      						<input type="hidden" value="${cons.consid}" name="consid">
      						<button class="btn btn-success btn-sm" style="float:right; margin-top:5px; font:small-caption;" onclick="return Check();">작성완료</button>
      						<a href="#" onclick="qu('${consid}');"><input type="button" class="btn btn-success btn-sm" style="float:right; margin-top:5px; margin-right:5px; font:small-caption;" value="작성취소"></a>
      						...
      						<div class="col-lg-8">
      						<input type="text" name="pftitle" id="pftitle" class="form-control" maxlength="30" placeholder="포트폴리오 제목 (30자 이하) (필수입력 입니다.)">
      						</div><!-- 8 끝 -->
      						</div><!-- row 끝 -->
