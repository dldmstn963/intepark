...
<meta charset="UTF-8">
<title>City</title>
<!-- <script src="/intepark/resources/js/City.js"></script>시공 지역 -->
...
$(function(){
	...
	$("#reqregion").on("change", function(){
		...
		//var reqregion2 = $("select[name=reqregion2]").val();

		//$("#b1").find('option:first').attr('selected', 'selected');
		showDiv(reqregion);
		});
...
<body>    
				...
				<div style="display:inline; margin-right:15px;">
					<select class="selectpicker" title="시를 선택해주세요" data-size="10" name="reqregion" id="reqregion" > <!-- data-size="10" option갯수제한 -->
							  ...
							  <option value="세종특별자치시">세종특별자치시</option><!-- 세종특별시는 하위지역 없음 -->
							  <option value="제주특별자치도">제주특별자치도</option>
					</select>
				</div>
				
				<div style="display:inline;" id="a0">
					<select class="selectpicker" title="구를 선택해주세요" data-size="10">
							  <option disabled>시를 먼저 선택해 주세요</option>
					</select>		  
				</div>
				
				<!-- 서울특별시 -->
				<div style="display:none;" id="a1">
					<select class="selectpicker" title="구를 선택해주세요" data-size="10" name="reqregion2" id="b1">
							<!-- <option disabled>시를 선택해 주세요</option> -->
				...
				<div style="display:none;" id="a2">
					<select class="selectpicker" title="구를 선택해주세요" data-size="10" name="reqregion2" id="b2">
							  <option value="강서구">강서구</option>
				...
				<div style="display:none;" id="a3">
					<select class="selectpicker" title="구를 선택해주세요" data-size="10" name="reqregion2" id="b3">
							  <option value="남구">남구</option>
				...
				<div style="display:none;" id="a4">
					<select class="selectpicker" title="구를 선택해주세요" data-size="10" name="reqregion2" id="b4">
				...
				<div style="display:none;" id="a5">
					<select class="selectpicker" title="구를 선택해주세요" data-size="10" name="reqregion2" id="b5">
				...
				<div style="display:none;" id="a6">
					<select class="selectpicker" title="구를 선택해주세요" data-size="10" name="reqregion2" id="b6">
				...
				<div style="display:none;" id="a7">
					<select class="selectpicker" title="구를 선택해주세요" data-size="10" name="reqregion2" id="b7">
							  <option value="남구">남구</option>
							  <option value="동구">동구</option>
							  <option value="북구">북구</option>
							  <option value="중구">중구</option>
				...
				<div style="display:none;" id="a8">
					<select class="selectpicker" title="구를 선택해주세요" data-size="10" name="reqregion2" id="b8">
				...
				<div style="display:none;" id="a9">
					<select class="selectpicker" title="구를 선택해주세요" data-size="10" name="reqregion2" id="b9">
				...
				<div style="display:none;" id="a10">
					<select class="selectpicker" title="구를 선택해주세요" data-size="10" name="reqregion2" id="b10">
				...
				<div style="display:none;" id="a11">
					<select class="selectpicker" title="구를 선택해주세요" data-size="10" name="reqregion2" id="b11">
				...
				<div style="display:none;" id="a12">
					<select class="selectpicker" title="구를 선택해주세요" data-size="10" name="reqregion2" id="b12">
				...
				<div style="display:none;" id="a13">
					<select class="selectpicker" title="구를 선택해주세요" data-size="10" name="reqregion2" id="b13">
				...
				<div style="display:none;" id="a14">
					<select class="selectpicker" title="구를 선택해주세요" data-size="10" name="reqregion2" id="b14">
							  <option value="계롱시">계롱시</option>
				...
				<!-- 충청북도 -->
				<div style="display:none;" id="a15">
					<select class="selectpicker" title="구를 선택해주세요" data-size="10" name="reqregion2" id="b15">
				...
				<!-- 제주특별자치도 -->
				<div style="display:none;" id="a16">
					<select class="selectpicker" title="구를 선택해주세요" data-size="10" name="reqregion2" id="b16">
