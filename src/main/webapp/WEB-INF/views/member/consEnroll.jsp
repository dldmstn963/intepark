...
<Br>
<H1><strong>시공사 회원가입</strong></H1><br>
...
<tr><th>상호명* : </th><td><input type="text" class="form-control has-feedback-left" name="companyname" maxlength="40"></td></tr>
<tr><th>A/S기간* : </th><td> <input type="radio" name="asdate" value="미제공" checked>&nbsp;<p style="display:inline">미제공</p>&nbsp;&nbsp;
							<input type="radio" name="asdate" value="6개월">&nbsp;<p style="display:inline">6개월</p>&nbsp;&nbsp;
							<input type="radio" name="asdate" value="1년">&nbsp;<p style="display:inline">1년</p><br>
							<input type="radio" name="asdate" value="2년">&nbsp;<p style="display:inline">2년</p>&nbsp;&nbsp;
							<input type="radio" name="asdate" value="2년이상">&nbsp;<p style="display:inline">2년이상</p>
						</td></tr>
<tr><th>경력* :</th><td> <input type="radio" name="career" value="5년 미만" checked>&nbsp;<p style="display:inline">5년 미만</p>&nbsp;&nbsp;
							<input type="radio" name="career" value="5~10년">&nbsp;<p style="display:inline">5~10년</p>&nbsp;&nbsp;
							<input type="radio" name="career" value="10~15년">&nbsp;<p style="display:inline">10~15년</p><br>
							<input type="radio" name="career" value="15~20년">&nbsp;<p style="display:inline">15~20년</p>&nbsp;&nbsp;
							<input type="radio" name="career" value="20년 이상">&nbsp;<p style="display:inline">20년 이상</p>
						</td></tr>
